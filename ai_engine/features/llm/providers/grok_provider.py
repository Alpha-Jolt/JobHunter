"""Grok provider — uses OpenAI SDK with xAI base URL."""
...
class GrokProvider(LLMProvider):
    """LLM provider backed by xAI Grok via OpenAI-compatible API.
    ...
    async def complete(
        ...
        """Send prompt to Grok and return structured JSON response."""
